...
using lab2_ex.Models.MyValidators;
...
namespace lab2_ex.Models
{
    public class Book
    {
        ...
        [MinLength(2, ErrorMessage ="Author cannot be less than 2"),
         MaxLength(30, ErrorMessage ="Author cannot be longer than 30")]
        public string Author { get; set; }


        [MinLength(10, ErrorMessage = "Summary cannot be less than 10"),
         MaxLength(20000, ErrorMessage = "Summary cannot be longer than 20000")]
        ...
        [NotMapped] // sa nu creeze baza de date
    ...
    public class Initp : DropCreateDatabaseAlways<DbCtx>  
    {
        protected override void Seed(DbCtx ctx)
        {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "HarperCollins", ContactInfo = new ContactInfo { PhoneNumber = "0741130693" } },
            ...
            ctx.Books.Add(new Book
            {
                ...
                Author = "Joel Stein",
                Publisher = new Publisher { Name = "Macmillan Publishers", ContactInfo = new ContactInfo { PhoneNumber = "0741130693" } },
                Genres = new List<Genre> {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "Scholastic", ContactInfo = new ContactInfo { PhoneNumber = "0741130693" } },
                Genres = new List<Genre> {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "Schol", ContactInfo = new ContactInfo { PhoneNumber = "0712365477" } },
